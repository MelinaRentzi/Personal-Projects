...
[ O1, O2 ,O3, O4 , O5 , O6 , O7 ]=operators100(Csorted); % "Crossover operation" (reproduction), all 7 operators
...
O7full=horzcat(O7,O7evaluated);
 ...
 O1care=care3100(O1,C,O1evaluated); %elegxos k efarmogh tou care and share algorithm
...
TaPantaOlaSorted=sort_care100(TaPantaOla); %kai ta 70 xrwmoswmata sortarismena
% hold on
% Y=TaPantaOlaSorted(1,101)
% 
% plot(M,Y,'*')
% hold off


Csorted=TaPantaOlaSorted(1:100,1:100); %epilegoume ta 10 prwta gia thn epomenh epanalhpsh
