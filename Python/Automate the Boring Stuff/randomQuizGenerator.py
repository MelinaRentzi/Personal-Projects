...
'Massachusetts':'Boston', 'Michigan':'Lansing', 'Minjnesota':'Saint Paul',
...
for quizNum in range(35):
	...
	for questionNum in range(50):
		...
		correctAnswer = capitals[states[questionNum]] # Correct answer  is the state of each capital
		wrongAnswers = list(capitals.values()) # Duplicates the list of all capitals
		del wrongAnswers[wrongAnswers.index(correctAnswer)] # From the list of capitals, removes the correct answer
		wrongAnswers = random.sample(wrongAnswers, 3) # From the remaining capitals, take a sample of 3 random capitals
		answerOptions = wrongAnswers + [correctAnswer] # Answer options are 3 wrong answers and 1 correcr
		random.shuffle(answerOptions) # Answers are randomized (not always correctAnswer = A)
